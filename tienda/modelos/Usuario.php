...
public function usuario_sucursal($idsucursal){
...
public function verificar($login,$clave){
	...
	$sql="SELECT idusuario,nombre,tipo_documento,num_documento,telefono,email,cargo,imagen,login,idsucursal FROM usuario WHERE login='$login' AND clave='$clave' AND condicion='1'";
	 return ejecutarConsulta($sql);
