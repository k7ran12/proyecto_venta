...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2019 a las 18:46:49
...
(6, 7, '00458', 'Lentes ray ban', 25, 'Modelo: RB-03470', '1542921092.jpg', 1, 1, NULL, NULL, NULL, NULL),
(7, 9, '0040kl', 'LIQUIDOS OFTALMICOS', 64, 'La solución única ReNu Multiplus utiliza una fórmula suave. Limpia, enjuaga, desinfecta y conserva las lentes de contacto blandas con todo cuidado. ReNu® MultiPlus™ aporta un plus de comodidad a las lentes de contacto.', '1542921128.jpg', 1, 2, NULL, NULL, NULL, NULL),
(8, 9, 'HJL-OP', 'Lentes de Contacto', 199, 'Lentes De Contacto Freshgo 100% Originales De 1 Año', '1542921149.jpg', 1, 1, NULL, NULL, NULL, NULL),
...
(34, 25, 6, 1, '30.00', '0.00'),
(35, 25, 7, 1, '300.00', '0.00'),
(36, 25, 7, 1, '300.00', '0.00'),
(37, 25, 8, 1, '80.00', '0.00');
...
INSERT INTO `persona` (`idpersona`, `tipo_persona`, `nombre`, `apellido_paterno`, `apellido_materno`, `tipo_documento`, `num_documento`, `direccion`, `telefono`, `email`) VALUES
...
(13, 'Optometra', 'Juan', 'Alvarado', 'Velasquez', 'DNI', '76600398', 'Jr manzanos 1156', '910108620', 'tauro24_vs@hotmail.com');
...
(25, 8, 1, 'Boleta', '1000', '12000', '2019-11-19 00:00:00', '0.00', '710.00', 'Aceptado', 1);
