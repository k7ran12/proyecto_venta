...
//almacenar permisos asigandos
	...
	if (isset($fetch)) {
		...
		$_SESSION['id_sucursal']=$fetch->idsucursal;

		//Obtener la sucursal
		$sucursal = $usuario->usuario_sucursal($fetch->idsucursal);
		$sucursal_fetch = $sucursal->fetch_object();
		$_SESSION['sucursal'] = $sucursal_fetch->nombre;
		//$_SESSION['sucursal'] = $fetch->idsucursal;
		...
		in_array(8, $valores)?$_SESSION['local']=1:$_SESSION['local']=0;
