...
<script src="https://kit.fontawesome.com/caf641ba08.js" crossorigin="anonymous"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>SIS</b>Venta  Optica</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
              ...
              <span class="hidden-xs"><i class="fas fa-globe-europe"></i> <?php echo $_SESSION['sucursal']; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Javier Yañac Vallejos -Desarrollo de software
...
if ($_SESSION['local']==1) {
  echo '<li class="treeview">
          <a href="#">
            <i class="fa fa-shopping-cart"></i> <span>Local</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
